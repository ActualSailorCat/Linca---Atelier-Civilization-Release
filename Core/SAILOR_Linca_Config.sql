...
VALUES	('CIVILIZATION_SAILOR_ATLEER', -- CivilizationType
		'LEADER_SAILOR_LINCA_BACKGROUND', -- PortraitBackground
		'LEADER_SAILOR_LINCA', -- LeaderType
		'LOC_LEADER_SAILOR_LINCA_NAME', -- LeaderName
		'ICON_LEADER_SAILOR_LINCA', -- LeaderIcon
		'LOC_TRAIT_LEADER_SAILOR_LINCA_UA_NAME', -- LeaderAbilityName
		'LOC_TRAIT_LEADER_SAILOR_LINCA_UA_DESCRIPTION', -- LeaderAbilityDescription
		'ICON_LEADER_SAILOR_LINCA', -- LeaderAbilityIcon
...
VALUES	('CIVILIZATION_SAILOR_ATLEER',
		'LEADER_SAILOR_LINCA',
		'UNIT_SAILOR_LINCA_UU',
		'ICON_UNIT_SAILOR_LINCA_UU',
		'LOC_UNIT_SAILOR_LINCA_UU_NAME',
		'LOC_UNIT_SAILOR_LINCA_UU_DESCRIPTION',
		30);
...
VALUES	('Players:Expansion1_Players', -- Domain
		...
		'ICON_LEADER_SAILOR_LINCA', -- LeaderIcon
		'LOC_TRAIT_LEADER_SAILOR_LINCA_UA_NAME', -- LeaderAbilityName
		'LOC_TRAIT_LEADER_SAILOR_LINCA_UA_XP_DESCRIPTION', -- LeaderAbilityDescription
		'ICON_LEADER_SAILOR_LINCA', -- LeaderAbilityIcon
		'LOC_CIVILIZATION_SAILOR_ATLEER_NAME', -- CivilizationName
		'ICON_CIVILIZATION_SAILOR_ATLEER', -- CivilizationIcon
		'LOC_TRAIT_CIVILIZATION_SAILOR_ATLEER_UA_NAME', --CivilizationAbilityName
